    ...
    for(let c = 0; c < parsedContent.length; c++) {
        switch(parsedContent[c]["@_key"]) {
            case "sshUser":
                ...
                break;
                case "proxypass":
                json["proxypass"] = parsedContent[c]["#text"];
                break;
                case "customSNI":
                json["customSNI"] = parsedContent[c]["#text"];
                break;
            case "sslProtocol":
            ...
            case "sshPass":
                ...
                break;
                case "sslHost":
                json["sslHost"] = parsedContent[c]["#text"];
                break;
            case "targetIdHardware":
                json["hwidValue"] = parsedContent[c]["#text"];
                break;
                case "dnspu":
                json["dnspu"] = parsedContent[c]["#text"];
                break;
                case "dnsst":
                json["dnsst"] = parsedContent[c]["#text"];
                break;
                case "dnsnameserver":
                json["dnsnameserver"] = parsedContent[c]["#text"];
                break;
                case "tunnelType":
            ...
            case "dnsResolver":
                ...
                break;
                case "dnsResolver2":
                json["DNS2"] = parsedContent[c]["#text"];
                break;
                case "dnsResolver1":
                json["DNS1"] = parsedContent[c]["#text"];
                break;
            ...
            case "proxyRemotoPorta":
                ...
                break;
                case "dnsKey":
                json["dnsKey"] = parsedContent[c]["#text"];
                break;
                case "chaveKey":
                json["chaveKey"] = parsedContent[c]["#text"];
                break;
                case "serverNameKey":
                json["serverNameKey"] = parsedContent[c]["#text"];
                break;
                case "proxyRemotePort":
                json["proxyRemotePort"] = parsedContent[c]["#text"];
                break;
            case "file.msg":
            ...
            case "proxyPayload":
                ...
                break;
                case "proxyRemote":
                json["proxyAddress"] = xmlent.decode(parsedContent[c]["#text"]);
                break;
            case "udpForward":
            ...
            case "blockTorrent":
                ...
                case "cUUID":
                json["cUUID"] = parsedContent[c]["#text"];
                break;
            case "file.validade":
                ...
                break;
                case "dnsForward":
                if(parsedContent[c]["#text"] == 1) {
                    json["dnsForward!?"] = "True";
                    break;
                } else {
                    json["dnsForward!?"] = "False";
                }
                break;
                case "sshPortLocal":
                json["sshPortLocall"] = parsedContent[c]["#text"];
                break;
            case "hostSniSSL":
            ...
            case "sniStr":
                ...
                break;
               case "allowedHWID":
                json["allowedHWID"] = parsedContent[c]["#text"];
                break; 
                case "sshPortLocal":
                json["sshPortLocal"] = parsedContent[c]["#text"];
                break;
            case "SNI":
                json["sniValue"] = parsedContent[c]["#text"];
                break;
