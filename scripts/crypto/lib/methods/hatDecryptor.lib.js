...
function parseDecoded(data) {
    ...
    */
    ...
    if(!!xd["profilev5"]) {
        //HA Tunnel Plus
        uwu["connectionMethod"] = [xd["profilev5"]["connection_mode"]];
        uwu["payload"] = xd["profilev5"]["custom_payload"];
        uwu["hostHeader"] = xd["profilev5"]["custom_host"];
        uwu["sniValue"] = xd["profilev5"]["custom_sni"];
        uwu["customresolver"] = xd["profilev5"]["custom_resolver"];
        uwu["dnsprimaryhost"] = xd["profilev5"]["dns_primary_host"];
        try { uwu["aotRealmHost"] = xd["profilev5"]["use_realm_host"].toString() } catch(e) {};
        uwu["aotRealmHostValue"] = xd["profilev5"]["realm_host"];
        try { uwu["aotOverrideHost"] = xd["profilev5"]["override_primary_host"].toString() } catch(e) {};
        uwu["aotPrimaryHost"] = xd["profilev5"]["primary_host"];
        try { uwu["serverPort"] = xd["profilev5"]["server_port"].toString() } catch(e) {};
    ...
    //uwu["credits"] = "Encryption research for this HCDrill module to => HACK_K (LEGEND) ✓";
    //uwu["dev"] = "I'M LEGEND";
