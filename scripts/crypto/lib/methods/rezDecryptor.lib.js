...
console.log('▶▶▶▶▶𝐃𝐞𝐜𝐫𝐲𝐩𝐭◀◀◀◀◀\nby: @JuanFCol\n\n');
console.log("【𝐉𝐅】PSInstall ➤ " +data.PSInstall);
console.log("【𝐉𝐅】DeviceID ➤ " +data.DeviceID);
console.log("【𝐉𝐅】Bloqueo root ➤ " +data.RootBlock);
console.log("【𝐉𝐅】MobileData ➤ " +data.MobileData);
console.log("【𝐉𝐅】Fecha expiracion ➤ " +data.ExpireDate);
console.log("【𝐉𝐅】Notas ➤ " +data.Message);
console.log("【𝐉𝐅】Payload ➤ " +data.Payload);
console.log("【𝐉𝐅】isDirect ➤ " +data.isDirect);
console.log("【𝐉𝐅】isSSL ➤ " +data.isSSL);
console.log("【𝐉𝐅】isWS ➤ " +data.isWS);
console.log("【𝐉𝐅】isDNS ➤ " +data.isDNS);
console.log("【𝐉𝐅】Server ➤ " +data.Server);
console.log('\n▶▶▶▶▶𝐃𝐞𝐜𝐫𝐲𝐩𝐭◀◀◀◀◀');
